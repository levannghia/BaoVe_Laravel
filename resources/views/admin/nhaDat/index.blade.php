        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{route('admin.nha.dat.add')}}" class="btn btn-info mb-3"><i
                    ...
                    <div class="row">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <h6 class="dropdown-header">Gallery</h6>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <a class="dropdown-item" href="/mua-ban-nha-dat/{{$item->slug}}" target="_blank" style="color: #5646ff"><i
                                                                    class="fa fa-eye"></i> View</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.nha.dat.edit', $item->id) }}"
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/nha-dat/delete-all"
    ...
    <script>
        $(document).ready(function() {
            $("[data-id-nb]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/nha-dat/noi-bac/" + id_nb + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/nha-dat/noi-bac/" + id_nb + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/nha-dat/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/nha-dat/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
