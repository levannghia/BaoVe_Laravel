...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form class="forms-sample" method="POST" action="{{ route('admin.recruit.update', $recruit_vi->recruit_id) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('title:vi', $recruit_vi->title) }}" id="slug" name="title:vi"
                                            placeholder="* Tiêu đề" onkeyup="changeToString()">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Mô tả</label>
                                        <textarea class="form-control" id="exampleTextarea1" rows="4"
                                            name="description:vi">{{ old('description:vi', $recruit_vi->description) }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Nội dung</label>
                                        <textarea class="form-control" id="content" rows="4"
                                            name="content:vi">{{ old('content:vi', $recruit_vi->content) }}</textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        <label for="slug">Tiêu đề</label>
                                        <input type="text" class="form-control"
                                            value="{{ old('title:en', $recruit_en->title) }}" name="title:en"
                                            placeholder="* Tiêu đề">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Mô tả</label>
                                        <textarea class="form-control" id="exampleTextarea1" rows="4"
                                            name="description:en">{{ old('description:en', $recruit_en->description) }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Nội dung</label>
                                        <textarea class="form-control" id="content1" rows="4"
                                            name="content:en">{{ old('content:en', $recruit_en->content) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="convert_slug" name="slug"
                                    value="{{ old('slug', $recruit_vi->slug) }}" placeholder="* slug">
                            </div>
                            <div class="form-group">
                                <label for="exampleTextarea1">Keywords (seo)</label>
                                <textarea class="form-control" id="exampleTextarea1" rows="4"
                                    name="keywords">{{ old('keywords', $recruit_vi->keywords) }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleTextarea1">Tình trạng</label>
                                <select class="js-example-basic-multiple w-100" name="status">
                                    <option value="0" {{ $recruit_vi->status == 0 ? 'selected' : '' }}>Ẩn</option>
                                    <option value="1" {{ $recruit_vi->status == 1 ? 'selected' : '' }}>Hiển thị</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{asset('public/upload/images/recruit/thumb/'.$recruit_vi->photo)}}" class="form-control img-fluid"
