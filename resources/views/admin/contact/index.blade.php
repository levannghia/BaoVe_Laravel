                    ...
                    <div class="row">
                                        ...
                                        @if (isset($contact))
                                            @foreach ($contact as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $i++ }}</td>
                                                    <td><a href="{{ route('admin.contact.edit', $item->id) }}"
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/contact/delete-all"
    ...
    <script>
        $(document).ready(function() {
            $("[data-id-nb]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/contact/noi-bac/" + id_nb + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/contact/noi-bac/" + id_nb + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/contact/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/contact/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
