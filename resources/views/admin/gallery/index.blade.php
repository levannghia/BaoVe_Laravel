        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.gallery.add', $product->id) }}" class="btn btn-info mb-3"><i
                    ...
                    <div class="row">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/gallery/delete-all" href="#"><i
    ...
    <script>
        $(document).ready(function() {
                ...
                $('.order_position').sortable({
                    ...
                    update: function(event, ui) {
                        ...
                        $.ajax({
                            ...
                            url: "{{route('admin.gallery.resorting')}}",
                            method: "POST",
                            data: {
                                array_id: array_id,
                            },
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/gallery/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/gallery/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
