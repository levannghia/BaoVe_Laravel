            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-nav">
                <div class="banner_image">
                    <a class="navbar-brand logo-img" href="/">
                        @if ($bannerHeader->lang == 'en')
                            <img src="{{ asset('public/upload/images/photo/thumb/en/' . $bannerHeader->photo) }}"
                                alt="">
                        @else
                            <img src="{{ asset('public/upload/images/photo/thumb/vi/' . $bannerHeader->photo) }}"
                                alt="">
                        @endif
                    </a>
                </div>
