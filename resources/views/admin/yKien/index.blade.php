        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{route('admin.y.kien.add')}}" class="btn btn-info mb-3"><i
                    ...
                    <div class="row">
                                        ...
                                        @if (isset($review))
                                            @foreach ($review as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $i++ }}</td>
                                                    <td><img src="{{asset('public/upload/images/yKien/thumb/'.$item->photo)}}"
                                                            class="img-fluid" alt=""></td>
                                                    <td><a href="{{ route('admin.y.kien.edit', $item->id) }}" title="Chỉnh sửa {{ $item->name }}">{{ $item->name }}</a></td>
                                                    {{-- <td>{{ $item->name }}</td> --}}
                                                    <td>
                                                        {{$item->address}}
                                                    </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.y.kien.edit', $item->id) }}"
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/y-kien-khach-hang/delete-all"
    ...
    <script>
        $(document).ready(function() {
            $("[data-id-nb]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/y-kien-khach-hang/noi-bac/" + id_nb + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/y-kien-khach-hang/noi-bac/" + id_nb + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/y-kien-khach-hang/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/y-kien-khach-hang/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                url: "/admin/y-kien-khach-hang/delete/" + id,
                                type: "GET",
                                data: {
                                    id: id
                                },
