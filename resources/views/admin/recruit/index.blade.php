        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.recruit.add') }}" class="btn btn-info mb-3"><i class="fa fa-plus"></i>
                        Thêm</a>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        @if (isset($recruit))
                                            ...
                                            @foreach ($recruit as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $i++ }}</td>
                                                    <td><img src="{{asset('public/upload/images/recruit/thumb/'.$item->photo)}}"
                                                            class="img-fluid" alt=""></td>
                                                    <td><a href="{{ route('admin.recruit.edit', $item->id) }}"
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.recruit.edit', $item->id) }}"
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/tuyen-dung/delete-all"
    ...
    <script>
        $(document).ready(function() {
            $("[data-id-nb]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/tuyen-dung/noi-bac/" + id_nb + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/tuyen-dung/noi-bac/" + id_nb + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_nb,
                            _token: _token
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/tuyen-dung/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/tuyen-dung/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                url: "/admin/tuyen-dung/delete/" + id,
                                type: "GET",
                                data: {
                                    id: id
                                },
